...
namespace MapScripts.Map11
{
    public static class LevelScriptObjects
    {
        ...
        {
            { TurretType.OUTER_TURRET, new[] { 3085, 3075, 3083, 3178 } },
            { TurretType.INNER_TURRET, new[] { 3085, 3075, 3153, 3068, 3178 } },
            { TurretType.INHIBITOR_TURRET, new[] { 3085, 3075, 3072, 3178 } },
            { TurretType.NEXUS_TURRET, new[] { 3085, 3075, 3072, 3178 } }
        };
        ...
        public static void CreateNex(string name, string model, Vector2 position, TeamId team)
        {
            ...
            nexusStats.HealthPoints.BaseValue = 10000.0f;
            nexusStats.Armor.FlatBonus = 500.0f;
            nexusStats.MagicResist.FlatBonus = 500.0f;
