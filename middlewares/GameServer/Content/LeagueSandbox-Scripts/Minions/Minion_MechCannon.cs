namespace CharScripts
{
    public class CharScriptRed_Minion_MechCannon : ICharScript
    {
        ...
        public void OnUpdate(float diff)
        {
            ...
            if (!_owner.HasBuff("MinionCannonBuff"))
            {
                AddBuff("MinionCannonBuff", float.MaxValue, 1, null, _owner, _owner, true);
            }
        }
    }
}
...
namespace CharScripts
{
    public class CharScriptBlue_Minion_MechCannon : ICharScript
    {
        ObjAIBase _owner;
        public StatsModifier StatsModifier { get; private set; } = new StatsModifier();
...
namespace Buffs
{
    class MinionCannonBuff : IBuffGameScript
    {
