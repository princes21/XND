...
namespace Buffs
{
    internal class LuluR_Backup : IBuffGameScript
    {
        ...
        public void OnActivate(AttackableUnit unit, Buff buff, Spell ownerSpell)
        {
            ...
            _healthBonus = 350 + 850 * ownerSpell.CastInfo.SpellLevel;
            StatsModifier.HealthPoints.BaseBonus = StatsModifier.HealthPoints.BaseBonus + 350 + 850 * ownerSpell.CastInfo.SpellLevel;
            unit.Stats.CurrentHealth = unit.Stats.CurrentHealth + 350 + 850 * ownerSpell.CastInfo.SpellLevel;
