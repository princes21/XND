...
namespace Spells
{
    public class LucianQ : ISpellScript
    {
        ...
        public void OnSpellPostCast(Spell spell)
        {
            ...
            AddBuff("Invulnerable", 1.25f, 1, spell, owner, owner);
        ...
        public void TargetExecute(Spell spell, AttackableUnit target, SpellMissile missile, SpellSector sector)
        {
            ...
            var damage = owner.Stats.AttackDamage.Total * 1.55f;
            if (owner.HasBuff("GreviousWound"))
            {
                owner.Stats.CurrentHealth += 30 + owner.Stats.AttackDamage.Total * 0.10f;
            }
            else
            {
                owner.Stats.CurrentHealth += 50 + owner.Stats.AttackDamage.Total * 0.35f;
            }
