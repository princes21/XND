...
public class DianaMixedShield : IBuffGameScript
{
    private Buff _buff;
    ...
    public void OnActivate(AttackableUnit unit, Buff buff, Spell spell)
    {
        ...
        float AD = owner.Stats.AttackDamage.Total * 2.35f;
        float AP = owner.Stats.AbilityPower.Total * 1.55f;
        var ShieldAmount = 120f + AD + AP;
