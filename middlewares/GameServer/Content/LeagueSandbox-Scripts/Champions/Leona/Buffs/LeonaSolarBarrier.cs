...
public class LeonaSolarBarrier : IBuffGameScript
{
    private Buff _buff;
    ...
    public void OnActivate(AttackableUnit unit, Buff buff, Spell spell)
    {
        ...
        float BonusMultiplier = 2.65f;
        float BonusArMr = owner.Stats.Armor.Total * BonusMultiplier + owner.Stats.MagicResist.Total * BonusMultiplier;
        var ShieldAmount = 150f + BonusArMr;
