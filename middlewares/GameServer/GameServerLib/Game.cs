...
namespace LeagueSandbox.GameServer
{
    ...
    public class Game
    {
        ...
        public float GetTimeIncreaseFactor()
        {
            ...
            {
                return (float)(Math.Ceiling(2 * (currentMinutes - 15)) * 0.425 / 100);
            }
            else if (currentMinutes >= 30 && currentMinutes < 45)
            {
                return 0.1275f + (float)(Math.Ceiling(2 * (currentMinutes - 30)) * 0.30 / 100);
            }
            else if (currentMinutes >= 45 && currentMinutes < 55)
            {
                return 0.2175f + (float)(Math.Ceiling(2 * (currentMinutes - 45)) * 1.45 / 100);
            }
            else if (currentMinutes >= 55 && currentMinutes < 5555)
            {
                return 0.5f + (float)(Math.Ceiling(2 * (currentMinutes - 55)) * 3.00 / 100);
            }
            else
            {
                return 0.5f; // Cap at 400% for games over 120 minutes
            }
        }
