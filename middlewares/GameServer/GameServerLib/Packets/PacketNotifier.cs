...
namespace PacketDefinitions420
{
    ...
    /// </summary>
    /// <param name="unit">Unit whose shield is being modified.</param>
    /// <param name="amount">Shield amount.</param>
    /// <param name="isPhysical">Whether the shield being modified is of Physical type.</param>
    /// <param name="isMagical">Whether the shield being modified is of Magical type.</param>
    /// <param name="stopShieldFade">Whether the shield should stay static or fade.</param>
    public void NotifyModifyShield(
        AttackableUnit unit,
        float          amount,
        bool           isPhysical,
        bool           isMagical,
