...
namespace LeagueSandbox.GameServer.API
{
    ...
    public static class ApiFunctionManager
    {
        ...
        public static void DisplayFloatingText(GameObject target, string message, FloatTextType type = FloatTextType.Absorbed, TeamId team = 0, int userId = -1, int param = 0)
        {
            var data = new FloatingTextData(target, message, type, param);
